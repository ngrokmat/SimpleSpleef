...
public class v1_15_R1 extends VersionHandler {

    public v1_15_R1(Plugin plugin, String versionName) {
    ...
    public ItemStack addData(ItemStack i, String s) {
        net.minecraft.server.v1_15_R1.ItemStack itemStack = CraftItemStack.asNMSCopy(i);
