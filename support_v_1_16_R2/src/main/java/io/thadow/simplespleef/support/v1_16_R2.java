...
public class v1_16_R2 extends VersionHandler {

    public v1_16_R2(Plugin plugin, String versionName) {
    ...
    public ItemStack addData(ItemStack i, String s) {
        net.minecraft.server.v1_16_R2.ItemStack itemStack = CraftItemStack.asNMSCopy(i);
